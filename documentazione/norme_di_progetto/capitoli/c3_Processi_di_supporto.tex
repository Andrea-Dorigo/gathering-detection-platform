...
\subsubsection{Stili di testo}\label{3.1.8.2}
...
\end{itemize}
\subsubsection{Termini del Glossario}\label{3.1.8.3}
...
\end{itemize}
\subsubsection{Elenchi puntati}\label{3.1.8.4}
...
\end{itemize}
\subsubsection{Formato di data}\label{3.1.8.5}
...
\end{itemize}
\subsubsection{Sigle}\label{3.1.8.6}
...
\subsubsection{Grafici}\label{3.1.9.2}
...
\subsubsection{Tabelle}\label{3.1.9.3}
...
\subsection{Metriche}\label{3.1.10}
\subsubsection{MPD03 Indice Gulpease}\label{3.1.10.1}
...
\subsubsection{Correttezza Ortografica}\label{3.1.10.2}
...
\subsection{Strumenti di stesura}\label{3.1.11}
\subsubsection{Latex}\label{3.1.11.1}
...
\section{Gestione della configurazione}\label{3.2}
