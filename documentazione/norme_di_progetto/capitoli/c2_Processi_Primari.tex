...
\end{itemize}
\paragraph{Descrizione}\label{2.2.3.1.2}\mbox{}\\
...
\paragraph{Struttura}\label{2.2.3.1.4}\mbox{}\\ %wip non è ancora perfettamente definito ???
...
\end{itemize}
\paragraph{Classificazione dei requisiti}\label{2.2.3.1.5}\mbox{}\\% RS1.2 = rs(requisiti specifici) 1(fase generale a cui si riferiscono) 2(numero del requisito incrementale)
...
\end{itemize}
\paragraph{Classificazione delle fasi}\label{2.2.3.1.6}\mbox{}\\% FC1.2 = fc(fasi capitolato) 1 (macro-fase) 2(fase precisa)
...
\end{itemize}
\paragraph{Qualità dei requisiti}\label{2.2.3.1.7}\mbox{}\\
