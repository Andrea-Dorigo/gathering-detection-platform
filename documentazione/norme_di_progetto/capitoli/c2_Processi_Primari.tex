...
La progettazione è suddivisa principalmente in due parti. Inizialmente viene realizzato il Proof of Concept$_{\scaleto{G}{3pt}}$ della Technology Baseline$_{\scaleto{G}{3pt}}$, successivamente viene approfondito e redatta nel documento tecnico allegato alla Product Baseline$_{\scaleto{G}{3pt}}$.%???da rivedere%
%\begin{itemize}
...
\subsubsection{Attività di progett}
