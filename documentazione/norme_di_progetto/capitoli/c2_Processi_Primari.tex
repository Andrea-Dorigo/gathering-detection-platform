...
\end{itemize}
\subsubsection{Descrizione}\label{2.2.3.1.2}
...
\subsubsection{Struttura}\label{2.2.3.1.4} %wip non è ancora perfettamente definito ???
...
\end{itemize}
\subsubsection{Classificazione dei requisiti}\label{2.2.3.1.5}% RS1.2 = rs(requisiti specifici) 1(fase generale a cui si riferiscono) 2(numero del requisito incrementale)
...
\end{itemize}
\subsubsection{Classificazione delle fasi}\label{2.2.3.1.6}% FC1.2 = fc(fasi capitolato) 1 (macro-fase) 2(fase precisa)
...
\end{itemize}
\subsubsection{Qualità dei requisiti}\label{2.2.3.1.7}
