...
Per poter implementare in modo corretto e continuativo ciò, per ogni periodo, verrà riportata, nel \textit{Piano di Qualifica}, una tabella contenente le seguenti informazioni per ogni processo:
\begin{itemize}
