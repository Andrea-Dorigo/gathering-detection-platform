...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{3cm-1.5\tabcolsep}|p{3,5cm}|p{3cm-2\tabcolsep}|}
		...
		\hline
		\centering v2.0.8 & 2021-04-22 & Igli Mezini & \centering \textit{Amministratore}  & \textit{Aggiunte \S~\ref{ProcessiPrimariFornituraDescrizione} e \S~\ref{ProcessiPrimariFornituraAspettative} e modificata \S~\ref{ProcessiOrganizzativiValutazioneDelProcesso} } & Alfredo Graziano \\
		\hline
