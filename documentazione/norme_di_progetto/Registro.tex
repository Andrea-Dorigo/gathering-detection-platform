...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{3cm-1.5\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\centering v2.0.1 & 20-03-2021 & Emma Roveroni & \centering \textit{Amministratore} & Margherita Mitillo & \textit{Aggiunta  sezione \S~\ref{ProcessiOrganizzativiProcessoDiMiglioramento} } \\
		\hline
