...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{3cm-1.5\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\centering v1.0.4 & 03-03-2021 & Emma Roveroni & \centering \textit{Amministratore} & Nome Cognome & \textit{Aggiunte sezione \S~\ref{ProcessiPrimariStrumentiMaven} e \S~\ref{ProcessiDiSupportoVerificaStrumenti} } \\
		\hline
		\centering v1.0.3 & 01-03-2021 & Emma Roveroni & \centering \textit{Amministratore} & Nome Cognome & \textit{Aggiunta sezione \S~\ref{ProcessiPrimariCodificaIntestazione} e aggiornata sezione \S~\ref{ProcessiPrimariCodificaStileDiCodifica} } \\
		\hline
