...
\subsubsection{Aggiunta di una webcam}\label{RequisitiDiSistemaEdInstallazioneInstallazioneInizializzazioneModuloAcquisitionAggiuntaDiUnaWebcam}
L'aggiunta di una nuova webcam al modulo di acquisizione è possibile attraverso pochi semplici passi:
\begin{enumerate}
