...
Il bottone Download dati PDF permette all'utente di scaricare, in formato pdf, i dati relativi alla città, al giorno e all'ora che si sta osservando.
%dati storici????
\paragraph{Download dati csv} 
Il bottone Download dati csv permette all'utente di scaricare, in formato csv, i dati relativi alla città, al giorno e all'ora che si sta osservando.
