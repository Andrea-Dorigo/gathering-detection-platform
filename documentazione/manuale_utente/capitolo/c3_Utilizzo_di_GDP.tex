...
(inserire foto)
Nel caso in cui non ci siano dati disponibili nel database per il luogo, il giorno e l'ora in questione, l'utente visualizzerà un messaggio di errore (alert??) che lo informerà del disguido e la mappa non mostrerà nessun dato. 
