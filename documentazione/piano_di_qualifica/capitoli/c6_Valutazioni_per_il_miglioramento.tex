...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|c|X|c|X}
			...
			\hline
		\end{tabularx}
		\captionof{table}{Tabella dei problemi relativi all'organizzazione}
	\end{center}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|X|c|X}
			...
			\hline
		\end{tabularx}
		\captionof{table}{Tabella dei problemi relativi ai ruoli}
	\end{center}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|X|c|X}
			...
			\hline
		\end{tabularx}
		\captionof{table}{Tabella dei problemi relativi agli strumenti di lavoro}
	\end{center}