...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{longtable}{|p{3cm}|p{8cm}|p{3cm}|}
			...
			\makecell[c]{\textbf{Id Test}} & \makecell[c]{\textbf{Descrizione}} & \makecell[c]{\textbf{Esito}} \\
			\hline
			\centering \textit{TI1} & Verifica che il sistema acquisica i dati attraverso il modulo conta persone che utlizza l'algoritmo di Yolo v3 & \makecell[tc]{\textit{NI}} \\
			\hline
			\centering \textit{TI2} & Verifica che il sistema invii i dati ottenuti dal modulo conta persone al database in modo corretto & \makecell[tc]{\textit{NI}}\\
			\hline
			\centering \textit{TI3} &  Verifica che il sistema invii i dati ottenuti dal modulo di machine learning al database in modo corretto &\makecell[tc]{\textit{NI}}\\
			\hline
			\centering \textit{TI4} &  Verifica che il sistema invii i dati presenti nel  database al web application in modo corretto &\makecell[tc]{\textit{NI}}\\
			\hline
			\rowcolor{white}
