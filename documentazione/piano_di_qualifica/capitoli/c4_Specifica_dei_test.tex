...
\begin{center}
	...
	\begin{longtable}{|p{1.5cm}|p{15cm}|}
		\hline
		\rowcolor{airforceblue}
		\multicolumn{2}{|c|}{\textbf{Tracciamento test di unità Spring}} \\
		\hline
		\rowcolor{airforceblue}
		\makecell[c]{\textbf{Id Test}} & \makecell[c]{\textbf{Metodo}} \\
		\hline
		\hline
		\centering TU01	& \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/\\DetectionCustomRepositoryImplTest.java:getCitiesTest()}\\
		\hline
		\centering TU02 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/\\DetectionCustomRepositoryImplTest.java:getLastValueTest()}\\
		\hline
		\centering TU03 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/\\DetectionCustomRepositoryImplTest.java:getDataRTTest()}\\
		\hline
		\centering TU04 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/\\DetectionCustomRepositoryImplTest.java:getLatLngsTest()}\\
		\hline
		\rowcolor{white}
...
\begin{center}
	...
	\begin{longtable}{|p{1.5cm}|p{15cm}|}
		\hline
		\rowcolor{airforceblue}
		\multicolumn{2}{|c|}{\textbf{Tracciamento test di unità Python}} \\
		\hline
		\rowcolor{airforceblue}
		\makecell[c]{\textbf{Id Test}} & \makecell[c]{\textbf{Metodo}} \\
		\hline
		\hline
		\centering TU05	& \makecell[c]{acquisition/main/test/test{\_}weather{\_}forecast.py:test{\_}response}\\
		\hline
		\centering TU06 & \makecell[c]{acquisition/main/test/test{\_}detect.py:test{\_}fetch{\_}read{\_}m3u8}\\
		\hline
		\centering TU07 & \makecell[c]{acquisition/main/test/test{\_}detect.py:test{\_}extract{\_}frame{\_}from{\_}video{\_}url}\\
		\hline
		\rowcolor{white}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{longtable}{|p{3cm}|p{8cm}|p{2cm}|p{2cm}|}
			...
			\hline
			\centering \textit{TI03} &  Verifica che il sistema invii i dati ottenuti dal modulo di machine learning al database in modo corretto &\makecell[tc]{\textit{I}} & \makecell[tc]{\textit{S}}\\
			\hline
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{longtable}{|p{3cm}|p{8cm}|p{2cm}|p{2cm}|}
			...
			\hline
			\textit{TSRSFO16} & Verifica che il modello di machine learning salvi i pesi e le predizioni in un file & \makecell[tc]{\textit{I}} & \makecell[tc]{\textit{S}}\\
			\hline
