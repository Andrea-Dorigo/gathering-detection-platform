...
\\
\textbf{Test di unità front end} %%margheee non voglio mettere una sezione ma un titoletto ma non so come si fa :(
\begin{center}
	\renewcommand{\arraystretch}{1.4}
	\begin{longtable}{|p{3cm}|p{8cm}|p{2cm}|p{2cm}|}
		\hline
	...
	\end{longtable}
\end{center}
%mancano quelli di vue 

\textbf{Test di unità back end} %%margheee non voglio mettere una sezione ma un titoletto ma non so come si fa :(
\\
\\
\begin{center}
	\renewcommand{\arraystretch}{1.4}
...
\textbf{Tracciamento test di unità front end} %%margheee non voglio mettere una sezione ma un titoletto ma non so come si fa :(
\begin{center}
	\renewcommand{\arraystretch}{1.4}
	\begin{longtable}{|p{1.5cm}|p{15cm}|}
		...
		\hline
		\hline
		\centering TU01	& \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/getCitiesTest()}\\
		\hline
		\centering TU02 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/ getLastValueTest()}\\
		\hline
		\centering TU03 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/getDataRTTest()}\\
		\hline
		\centering TU04 & \makecell[c]{proof{\_}of{\_}concept/webapp/webapp/src/test/java/com/webapp/\\data/mongodb/DetectionCustomRepositoryImplTest/getLatLngsTest()}\\
		\hline
		\rowcolor{white}
...
\end{center}
\textbf{Tracciamento test di unità back end} %%margheee non voglio mettere una sezione ma un titoletto ma non so come si fa :(
\begin{center}
	\renewcommand{\arraystretch}{1.4}
	\begin{longtable}{|p{3cm}|p{10cm}|}
		...
		\hline
		\hline
		\centering TU05	& \makecell[c]{test{\_}weather{\_}forecast.py/test{\_}response}\\
		\hline
		\centering TU06 & \makecell[c]{test{\_}detect.py/test{\_}fetch{\_}read{\_}m3u8}\\
		\hline
		\centering TU07 & \makecell[c]{test{\_}detect.py/test{\_}extract{\_}frame{\_}from{\_}video{\_}url}\\
		\hline
		\rowcolor{white}
		\caption{\textbf{Tracciamento dei test di unità - Back end}}
	\end{longtable}
