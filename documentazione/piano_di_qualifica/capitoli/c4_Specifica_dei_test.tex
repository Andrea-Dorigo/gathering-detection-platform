...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{longtable}{|p{3cm}|p{8cm}|p{2cm}|p{2cm}|}
			...
			\hline
			\textit{TARSFD37} & Verifica che l’utente possa poter visualizzare la lista di tutte le città presenti nel database in ordine crescente per rischio & \makecell[tc]{\textit{NI}} & \makecell[tc]{\textit{-}}\\
			\hline
			\rowcolor{white}
