...
\begin{center}
	...
	\begin{longtable}{|p{3cm}|p{10cm}|}
		...
		\hline
		\hline
		TU05	& test{\_}weather{\_}forecast.py/test{\_}response \\
		\hline
		TU06 & test{\_}detect.py/test{\_}fetch{\_}read{\_}m3u8 \\
		\hline
		TU07 & test{\_}detect.py/test{\_}extract{\_}frame{\_}from{\_}video{\_}url  \\
		\hline
		\rowcolor{white}
