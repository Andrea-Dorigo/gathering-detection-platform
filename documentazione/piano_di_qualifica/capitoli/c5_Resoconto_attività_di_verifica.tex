...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	\begin{center}
		...
		\begin{longtable}[c]{|p{4cm}|p{3cm}|}
			...
			\makecell[c]{\textbf{Realizzazione}} & \makecell[c]{\textbf{Quantità}}\\
			\hline
			\textit{Soddisfatto} & \makecell[c]{??}\\
			\hline
			\textit{Non soddisfatto} & \makecell[c]{??} \\
			\hline
			\textit{Totali} & \makecell[c]{??} \\
		\end{longtable}
		\captionof{table}{\textbf{PROS}}
	\end{center}
	...
	{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
		\begin{center}
			...
			\begin{longtable}[c]{|p{4cm}|p{3cm}|}
				...
				\makecell[c]{\textbf{Realizzazione}} & \makecell[c]{\textbf{Quantità}}\\
				\hline
				\textit{Implementato} & \makecell[c]{??}\\
				\hline
				\textit{Non Implementato} & \makecell[c]{??} \\
				\hline
				\textit{Totali} & \makecell[c]{??} \\
			\end{longtable}
			\captionof{table}{\textbf{MQPD01}}
		...
		{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
			...
			Il gruppo ha concluso lo svolgimento dei primi test di unità dei differenti moduli sviluppati. Di seguito è presente una tabella che indica il numero dei test eseguiti, i test che passano e i test che generano errori.\\
			%\textit{Nel caso in cui il gruppo riesca a trovare un'implementazione dei test di unità del modulo legato al machine learning$_{\scaleto{G}{3pt}}$, la metrica verrà aggiornata nella fase successiva}
			...
			{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
				\begin{center}
					...
					\begin{longtable}[c]{|p{3cm}|p{3cm}|p{3cm}|p{4cm}|}
						...
						\textit{Acquisizione} & \makecell[c]{3} & \makecell[c]{3} & \makecell[c]{0} \\
						\hline
						\textit{Back-end} & \makecell[c]{5?} & \makecell[c]{5?} & \makecell[c]{0} \\
						\hline
							...
							{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
								\begin{center}
									...
									\begin{tabularx}{11,70cm}{|c|c|c|}
										...
										\hline
										\textit{Norme di Progetto 4.0.0} & ? & \textit{Superato}\\
										\hline
										\textit{Piano di Progetto 4.0.0} & ? & \textit{Superato}\\
										\hline
										\textit{Piano di Qualifica 4.0.0} & ? & \textit{Superato}\\
										\hline
										\textit{Manuale Utente 2.0.0} & ? & \textit{Superato}\\
										\hline
										\textit{Manuale Sviluppatore 2.0.0} & ? & \textit{Superato}\\
										\hline
								...
								{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
									\begin{center}
										...
										\begin{tabularx}{9.5cm}{|c|c|c|}
											...
											\textbf{Documento} & \textbf{Indice di Gulpease} & \textbf{Esito}\\
											\hline
											\textit{v\_e\_2021-03-19} & ? & \textit{Superato}\\
											\textit{v\_e\_2021-03-25} & ? & \textit{Superato}\\
											\textit{v\_i\_2021-03-26} & ? & \textit{Superato}\\
											\textit{v\_e\_2021-03-29} & ? & \textit{Superato}\\
											\textit{v\_e\_2021-03-31} & ? & \textit{Superato}\\
											\textit{v\_i\_2021-04-09} & ? & \textit{Superato}\\
											\textit{v\_i\_2021-04-12} & ? & \textit{Superato}\\
											\textit{v\_e\_2021-04-15} & ? & \textit{Superato}\\
											\textit{v\_e\_2021-04-16} & ? & \textit{Superato}\\
											\textit{v\_i\_2021-04-19} & ? & \textit{Superato}\\
											\hline
										\end{tabularx}
										\captionof{table}{\textbf{Elenco Indici di Gulpease$_{\scaleto{G}{3pt}}$ dei verbali fino alla RQ}}
									\end{center}
