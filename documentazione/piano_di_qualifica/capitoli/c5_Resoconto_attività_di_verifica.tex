...
\begin{itemize}
	\item Correzione degli errori sia ortografici che sintattici, non fedeli alle norme tipografiche fissate nelle \textit{Norme di Progetto v2.0.0}.
\end{itemize}
...
\section{Revisione di Progettazione} \label{RevisioneDiProgettazione}
...
hanno seguito, per ogni documento, i metodi di \textit{Walkthrough$_G$} ed \textit{Inspection$_G$} relative all’analisi statica, stabilite nelle \textit{Norme di Progetto v2.0.0}.
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}	
	\begin{center}
		...
		\begin{tabularx}{11.65cm}{|c|c|c|}
			...
			\textbf{Documento} & \textbf{Indice di Gulpease} & \textbf{Esito}\\
			\hline
			\textit{Analisi dei Requisiti v2.0.0} & 92  & \textit{Superato}\\
			\hline
			\textit{Norme di Progetto v2.0.0} & 86 & \textit{Superato}\\
			\hline
			\textit{Piano di Progetto v2.0.0} & ?? & \textit{Superato}\\
			\hline
			\textit{Piano di Qualifica v2.0.0} & ?? & \textit{Superato}\\
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Elenco Indici di Gulpease$_{\scaleto{G}{3pt}}$ dei documenti versione v2.0.0}}
	\end{center}
