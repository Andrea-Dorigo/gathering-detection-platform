...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{3cm-1.5\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\hline
		\centering v0.0.6 & 2021-04-19 & Mattia Cocco & \centering \textit{Progettista} & \textit{Fine stesura \S~\ref{ArchitetturaDelProdotto}} & Andrea Cecchin\\
		\hline
		\hline
		...
		\hline
		\hline
		\centering v0.0.5 & 2021-04-14 & Mattia Cocco & \centering \textit{Progettista} & \textit{Fine stesura \S~\ref{ProceduraDiInstallazione}, aggiunti \S~\ref{ProceduraDiInstallazioneAggiuntaDiUnaWebcam}} & Andrea Cecchin \\
		\hline
		\hline
