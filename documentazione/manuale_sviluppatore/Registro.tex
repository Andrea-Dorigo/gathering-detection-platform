...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{3cm-1.5\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\hline
		\centering v0.1.0 & 2021-04-25 &\centering - &\centering - & \textit{Revisione complessiva del documento} & Andrea Dorigo\\
		\hline
		\hline
		\centering v0.0.7 & 2021-04-25 & Andrea Dorigo & \centering \textit{Progettista} & \textit{Stesura \S~\ref{Test}} & Andrea Cecchin\\
		\hline
		\hline
