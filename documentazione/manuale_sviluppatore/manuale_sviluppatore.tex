...
\begin{titlepage}
	\begin{center}
		...
		\begin{table}[H]
			...
			\centering
			\begin{tabular}{r | l}
				\textbf{Versione} & 2021-04-26 \\%RIGA PER INSERIRE LA VERSIONE ULTIMA DEL DOCUMENTO
				\textbf{Data approvazione} & 1.0.0\\
...
\makeatother
	...
	\input{capitoli/c3_Procedura_di_installazione}
	\input{capitoli/c4_Tecnologie_e_librerie_coinvolte}
	\input{capitoli/c5_Architettura_del_prodotto}
	\input{capitoli/c6_Test}
	\input{capitoli/c7_Informazioni_aggiuntive}
	\input{capitoli/c8_Glossario}
