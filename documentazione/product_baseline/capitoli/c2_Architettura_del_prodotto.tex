...
\subsection{Diagramma di attività modulo Acquisition}
\begin{center}
	\begin{figure}[H]
...
\begin{enumerate}
	...
	\item creo un set di dati da predire;
	\item definisco il modello della predizione;
	\item alleno il modello con i dati prelevati e controllati;
	\item utilizzo il modello allenato per ricavare le previsioni dal set di dati creato nel punto 2;
