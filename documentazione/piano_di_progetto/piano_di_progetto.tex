...
\begin{titlepage}
	\begin{center}
		...
		\begin{table}[H]
			...
			\centering
			\begin{tabular}{r | l}
				\textbf{Versione} & 3.0.0 \\%RIGA PER INSERIRE LA VERSIONE ULTIMA DEL DOCUMENTO
				\textbf{Data approvazione} & 2021-04-24\\
				...
				\textbf{Verificatori} & \makecell[tl]{Emma Roveroni \\ Andrea Cecchin \\ Igli Mezini \\ Andrea Dorigo \\ Alfredo Graziano} \\
