...
\begin{titlepage}
    ...
    \begin{table}[H]
        ...
        %MAKECELL SERVE PER POI ANDARE A CAPO ALL'INTERNO DELLA CELLA
            ...
            \textbf{Lista distribuzione} & \makecell{Jawa Druids \\ Tullio \\ Sync Lab}\\
            \textbf{Uso} & Esterno
        \end{tabular}
    \end{table}
					\vspace{.8cm}
    ...
    \fontsize{17}{10}\textbf{Sommario}\\
		\vspace{.3cm}
    Il presente documento contiene la pianificazione delle attività del gruppo Jawa Druids atte al soddisfacimento del capitolato \textit{GDP: Gathering Detection Platform} di Sync Lab.
    \end{center}
\end{titlepage}
\makeatother
