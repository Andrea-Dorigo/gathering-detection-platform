...
Grazie al risparmio ottenuto in questa fase, il consuntivo finale è di 14510€, 30€ in più di quanto preventivato.
Tuttavia, trattandosi di una cifra trascurabile, il preventivo a finire sarà ridotto a 14480€, come il preventivo iniziale.
...
Nella tabella successiva vengono descritti i costi derivate dalle ore impiegate nei singoli ruoli che sono state rendicontate, cioè dalla fase di \textit{Progettazione architetturale} inclusa.
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	\begin{center}
		...
		\begin{tabularx}{10cm}{|X|c|c|}
			...
			Programmatore & 120(-29) & 1650\euro(-585\euro)\\
			\hline
			Verificatore & 195(+2) & 2880\euro(+30\euro)\\
			\hline
			\textbf{Totale Preventivo} & \textbf{735} & \textbf{14480\euro}\\
			\hline
			\textbf{Totale Consuntivo} & \textbf{735} & \textbf{14510\euro}\\
			\hline
			\textbf{Differenza} & \textbf{0} & \textbf{+30\euro}
		\end{tabularx}
