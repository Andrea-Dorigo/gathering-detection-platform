...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
			\textit{Incremento 1} & 5(+0) & 8(+5) & 0(-19) & 5(+0) & 0(+0) & 14(+0) & 32(-19) \\
			\hline
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
			\textit{Incremento 4} & 8(+3) & 6(+0) & 14(+7) & 0(+0) & 0(+0) & 20(+4) & 48(+10) \\
			\hline
			...
			\hline
			Totale ore ruolo & 27(+5) & 30(+0) & 14(+7) & 39(+0) & 57(+6) & 36(+4) & 203(+18)\\
			\hline
		\end{tabularx}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\textbf{Incremento} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale ore}\\
			\hline
			\textit{Incremento 10} & 3(+0) & 3(+0) & 9(+9) & 8(+0) & 0(+0) & 30(+0) & 53(+9)\\
			\hline
			\textit{Incremento 11} & 2(+0) & 2(+0) & 10(+10) & 2(+0) & 0(+0) & 0(+0) & 16(+10)\\
			\hline
			Totale ore ruolo & 5(+0) & 5(+0) & 0(+0) & 10(+0) & 0(+0) & 30(+0) & 69(+19)\\
			\hline
		\end{tabularx}
	...
	{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
		\begin{center}
			...
			\begin{tabularx}{10cm}{|X|c|c|}
				...
				\hline
				Analista & 19(+19) & 475\euro(+475\euro)\\
				\hline
				...
				\hline
				\textbf{Totale Consuntivo} & \textbf{69} & \textbf{1395\euro}\\
				\hline
				\textbf{Differenza} & \textbf{+19} & \textbf{+475\euro}
			\end{tabularx}
			\captionof{table}{\textbf{Consuntivo del terzo periodo}}
		\end{center}
		
\subsubsection{Conclusioni}\label{ConsuntivoTerzoPeriodoDiProgettazioneDiDettaglioCodificaConclusioni}
Come emerso dalla tabella precedente, il bilancio risulta negativo in quanto abbiamo dovuto impiegare più ore nel ruolo di \textit{Analista} rispetto alle ore preventivate. Sono stati riscontrati vari errori da parte del committente nel documento legato all'\textit{Analisi dei Requisiti} che ha portato ad una rivisitazione di quest'ultimo.
...
Il preventivo a finire di questo periodo presenta un surplus di 475\euro. (??)
			...
			{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
				\begin{center}
					...
					\begin{tabularx}{10cm}{|X|c|c|}
						...
						\hline
						\textbf{Totale Consuntivo} & \textbf{350} & \textbf{6893\euro}\\
						\hline
						\textbf{Differenza} & \textbf{35} & \textbf{710\euro}
					\end{tabularx}
					\captionof{table}{\textbf{Consuntivo complessivo delle fasi}}
				\end{center}
...
Il preventivo a finire risulta quindi con un surplus di 35\euro (??)