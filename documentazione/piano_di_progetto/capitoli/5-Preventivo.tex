...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Prospetto delle ore degli incrementi del primo periodo della fase di Validazione e Collaudo}}
	\end{center}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Distribuzione oraria del primo periodo della fase di Validazione e Collaudo}}
	\end{center}
...
\begin{figure}[!h]
	\begin{center}
		...
		\caption{Istogramma della ripartizione oraria durante il primo periodo della fase di Validazione e Collaudo}
	\end{center}
\end{figure}
\clearpage

\subsubsection{Prospetto economico}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoPrimoPeriodoProspettoEconomico}
\quad
\def\tabularxcolumn#1{m{#1}}
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	\begin{center}
		...
		\begin{tabularx}{7cm}{|X|c|c|}
			...
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Prospetto dei costi per ruolo nel primo periodo della fase di Validazione e collaudo}}
	\end{center}
...
\subsubsection{Prospetto delle ore degli incrementi}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoSecondoPeriodoIncrementi}
Di seguito riportiamo le ore che prevediamo necessitino singolarmente gli incrementi relativi a questo periodo.
\quad
\def\tabularxcolumn#1{m{#1}}
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Prospetto delle ore degli incrementi del secondo periodo della fase di Validazione e Collaudo}}
	\end{center}
	
	\subsubsection{Prospetto orario}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoSecondoPeriodoProspettoOrario}
	In questo periodo la distribuzione oraria tra i componenti del gruppo sarà la seguente:
	...
	{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
		...
		\begin{center}
			...
			\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
				...
				\hline
			\end{tabularx}
			\captionof{table}{\textbf{Distribuzione oraria del secondo periodo della fase di Validazione e Collaudo}}
		\end{center}
		...
		\begin{figure}[!h]
			\begin{center}
				...
				\caption{Istogramma della ripartizione oraria durante il secondo periodo della fase di Validazione e Collaudo}
			\end{center}
		\end{figure}
		\clearpage
		
		\subsubsection{Prospetto economico}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoSecondoPeriodoProspettoEconomico}
		\quad
		\def\tabularxcolumn#1{m{#1}}
		{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
			\begin{center}
				...
				\begin{tabularx}{7cm}{|X|c|c|}
					...
					\hline
				\end{tabularx}
				\captionof{table}{\textbf{Prospetto dei costi per ruolo nel secondo periodo della fase di Validazione e collaudo}}
			\end{center}
			...
			\begin{figure}[!ht]
				\begin{center}
					...
					\caption{Grafico a torta della ripartizione per ruolo dei costi del secondo periodo della fase di Validazione e Collaudo}
				\end{center}
			\end{figure}
		
\subsection{Terzo periodo}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoTerzoPeriodo}
\subsubsection{Prospetto delle ore degli incrementi}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoTerzoPeriodoIncrementi}
Di seguito riportiamo le ore che prevediamo necessitino singolarmente gli incrementi relativi a questo periodo.
\quad
\def\tabularxcolumn#1{m{#1}}
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
			...
			\hline
		\end{tabularx}
		\captionof{table}{\textbf{Prospetto delle ore degli incrementi del terzo periodo della fase di Validazione e Collaudo}}
	\end{center}
	
	\subsubsection{Prospetto orario}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoTerzoPeriodoProspettoOrario}
	In questo periodo la distribuzione oraria tra i componenti del gruppo sarà la seguente:
	...
	{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
		...
		\begin{center}
			...
			\begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
				...
				\hline
			\end{tabularx}
			\captionof{table}{\textbf{Distribuzione oraria del terzo periodo della fase di Validazione e Collaudo}}
		\end{center}
		...
		\begin{figure}[!h]
			\begin{center}
				...
				\caption{Istogramma della ripartizione oraria durante il terzo periodo della fase di Validazione e Collaudo}
			\end{center}
		\end{figure}
		\clearpage
		
		\subsubsection{Prospetto economico}\label{PreventivoFaseDiProgettazionediValidazioneECollaudoTerzoPeriodoProspettoEconomico}
		\quad
		\def\tabularxcolumn#1{m{#1}}
		{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
			\begin{center}
				...
				\begin{tabularx}{7cm}{|X|c|c|}
					...
					\hline
				\end{tabularx}
				\captionof{table}{\textbf{Prospetto dei costi per ruolo nel terzo periodo della fase di Validazione e collaudo}}
			\end{center}
			...
			\begin{figure}[!ht]
				\begin{center}
					...
					\caption{Grafico a torta della ripartizione per ruolo dei costi del terzo periodo della fase di Validazione e Collaudo}
				\end{center}
			\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\caption{Grafico a torta della ripartizione per ruolo delle ore nella fase di Validazione e collaudo}
	\end{center}
\end{figure}
