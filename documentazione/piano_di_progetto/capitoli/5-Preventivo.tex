...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_analisi.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_analisi.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_consolidamento_requisiti.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_consolidamento_requisiti.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_progettazione_architetturale.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_progettazione_architetturale.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_progettazione_dettaglio.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_progettazione_dettaglio.png}
		\caption{Grafico a torta della ripartizione per ruolo delle ore nel periodo di Progettazione
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_validazione.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_validazione.png}
		\caption{Istogramma della ripartizione delle ore durante il periodo di Validazione e
			collaudo}
	\end{center}
\end{figure}
...
Nella seguente tabella vengono riportate il totale delle ore del progetto, sono presenti sia le ore di investimento, sia quelle rendicontate a carico del committente.
\quad
\def\tabularxcolumn#1{m{#1}}
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_suddivisione_lavoro.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_suddvisione_lavoro.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/istogramma_rendicontate.png}
...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../immagini/torta_rendicontate.png}
