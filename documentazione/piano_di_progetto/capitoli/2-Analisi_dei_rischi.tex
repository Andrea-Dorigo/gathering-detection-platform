...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|c|X|}
			...
			Inoltre si cercherà di distribuire i task più complessi a più membri, in modo da favorire l'avanzamento del lavoro.  \\
			\hline
		\end{tabularx}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{|c|X|}
			...
			\hline
			\textit{Piano di contingenza} & Il \textit{Responsabile di progetto} avrà l'incarico di riassegnare i compiti in modo da riuscire a completare i task nel tempo stimato, così da non avere ritardi nel portarli a termine.
