...
Sulla base di queste considerazioni e sulla valutazione della natura del progetto, è stato adottato il modello di sviluppo \textbf{incrementale}, il quale prevede lo sviluppo del prodotto tramite incrementi multipli e sucessivi, ossia dei rilasci che realizzano ciascuno una nuova funzionalità che viene integrata nel sistema.
