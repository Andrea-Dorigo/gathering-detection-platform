...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{2,5cm-1.5\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\centering v3.0.3 & 2021-05-22 & Andrea Dorigo & \centering \textit{Responsabile} & \textit{Aggiunto \S~\ref{ConsutivoFaseValidazioneCollaudo} } & \centering Margherita Mitillo \\
		\tabularnewline
		\hline
		\centering v3.0.2 & 2021-05-21 & Andrea Dorigo & \centering \textit{Responsabile} & \textit{Riformattato \S~\ref{PreventivoFaseDiProgettazionediValidazioneECollaudo} } & \centering Margherita Mitillo \\
		\tabularnewline
		\hline
