...
\begin{titlepage}
	\begin{center}
		\vspace*{-4cm}
		\author{Jawa Druids}
		\title{Verbale Esterno 2021-04-15}
		...
		\begin{table}[H]
			...
			\begin{tabular}{r | l}
				...
				\textbf{Data approvazione} & 2021-04-18\\
		...
		\vspace{0.1cm}
		Verbale esterno del giorno 2021-04-15 riguardo una discussione sull'architettura del prodotto con il team dell'azienda Sync 
		Lab.
	\end{center}
\end{titlepage}
\makeatother
