...
\begin{titlepage}
	\begin{center}
		\vspace*{-4cm}
		\author{Jawa Druids}
		\title{Verbale Esterno 2021-03-31}
		...
		\begin{table}[H]
			...
			\begin{tabular}{r | l}
				...
				\textbf{Data approvazione} & 2021-04-02\\
		...
		\vspace{0.1cm}
		Verbale esterno del giorno 2021-03-31 riguardo un breve colloquio con Dario Stagnitto dipendente dell'azienda Sync 
		Lab.
	\end{center}
\end{titlepage}
\makeatother
