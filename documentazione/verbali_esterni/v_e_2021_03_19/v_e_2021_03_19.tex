...
\begin{titlepage}
	\begin{center}
		\vspace*{-4cm}
		\author{Jawa Druids}
		\title{Verbale Esterno 2021-03-19}
		...
		\begin{table}[H]
			...
			\begin{tabular}{r | l}
				...
				\textbf{Data approvazione} & 2021-03-21\\
				\textbf{Responsabile} & Andrea Dorigo\\
				\textbf{Redattori} & Igli Mezini \\
		...
		\vspace{0.1cm}
		Verbale esterno del giorno 2021-03-19 riguardo la presentazione del POC svolta attraverso Google Meet con Fabio Pallaro e il suo team di Sync Lab.
	\end{center}
\end{titlepage}
\makeatother
