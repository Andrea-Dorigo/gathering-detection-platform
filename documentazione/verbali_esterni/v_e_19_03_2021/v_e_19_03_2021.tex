...
\begin{titlepage}
	\begin{center}
		\vspace*{-4cm}
		\author{Jawa Druids}
		\title{Verbale Esterno 19-03-2021}
		...
		\begin{table}[H]
			...
			\begin{tabular}{r | l}
				...
				\textbf{Data approvazione} & 21-03-2021\\
		...
		\vspace{0.1cm}
		Verbale esterno del giorno 19-03-2021 riguardo la presentazione del POC avuta su Google Meet con Fabio Pallaro e il suo team di Sync Lab.
	\end{center}
\end{titlepage}
\makeatother
