...
\begin{titlepage}
	\begin{center}
		\vspace*{-4cm}
		\author{Jawa Druids}
		\title{Verbale Esterno 2021-04-16}
		...
		\vspace{0.1cm}
		Verbale esterno del giorno 2021-04-16 riguardo una discussione sullo sviluppo del modulo back-end con Spring del prodotto con il team dell'azienda Sync 
		Lab.
	\end{center}
\end{titlepage}
\makeatother
