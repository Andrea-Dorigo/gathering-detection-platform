...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{2,5cm-2\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\hline
		\centering v0.0.2 & 10-12-2020 & Andrea Cecchin & \centering \textit{Analista} & \centering - & \textit{Aggiunte sezioni \S~\ref{descrizioneGeneraleCaratteristicheProdotto}, \S~\ref{descrizioneFunzionalitàDelProdotto}} \\
		\hline
