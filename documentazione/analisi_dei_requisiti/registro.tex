...
\begin{center}
	...
	\begin{longtable}[c]{|p{2cm-1\tabcolsep}|p{2cm}|p{3cm-2\tabcolsep}|p{2,5cm-2\tabcolsep}|p{2,5cm}|p{4cm-2\tabcolsep}|}
		...
		\centering v2.2.0 & 01-03-2021 & Margherita Mitillo & \centering \textit{Analista} & \centering  & \textit{Rielaborazione ed aggiornamento del capitolo \S~\ref{Requisiti}} \\
		\hline
		\hline
		\centering v2.1.0 & 01-03-2021 & Margherita Mitillo & \centering \textit{Analista} & \centering Alfredo Graziano & \textit{Rielaborazione ed aggiornamento del capitolo \S~\ref{CasiDUso}} \\
		\hline
		...
		\hline
		\centering v0.1.3 & 05-01-2021 & Igli Mezini & \centering \textit{Analista} & \centering - & \textit{Aggiunte sezioni \S~\ref{DescrizioneGeneraleCaratteristicheUtente}, \S~\ref{RequisitiPrestazionali}, \S~\ref{RequisitiDiQualita}, \S~\ref{RequisitiDiVincolo} .} \\
		\hline
