...
\subsubsection{UC1 - Visualizzazione informazioni sulla mappa} %parzialmente corretto
\begin{center}
	\begin{figure}[H]
...
\subsubsection{UC2 - Visualizzazione messaggio per la mancanza di dati } %parzialmente corretto
\begin{itemize}
	\item \textbf{Attori primari}: utente generico;
...
\subsubsection{UC3 - Selezione città da visualizzare nella mappa} %parzialmente corretto
\begin{center}
	\begin{figure}[H]
...
\subsubsection{UC4.1 - Selezione dell’orario}
\begin{itemize}
	\item \textbf{Attori primari}: utente generico;
...
\section{Casi d'uso tra il front end ed il back end}
%spiegazione sezione
...
\subsubsection{UC5 - Richiesta dati}
%insert uml
\begin{itemize}
...
\subsubsection{UC5.2 - Richiesta dati in tempo reale}
\begin{itemize}
	\item \textbf{Attori primari}: sistema front end;
