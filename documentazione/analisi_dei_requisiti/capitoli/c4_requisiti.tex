...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\begin{longtable}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|} 
			...
			\hline
			\centering RSFF2 & Realizzazione di simulatori di altre sorgenti dati sia dei dati storici/in monitoraggio che dati previsionali & \centering Facoltativo & \makecell[tc]{Capitolato \\ FC1.1} \\
			\hline
			...
			\hline
			\centering RSFO4.1 & Archiviazione di tutti i dati acquisiti nel databse & \centering Obbligatorio & \makecell[tc]{Capitolato \\ FC1.2}  \\
			\hline
			\centering RSFO4.2 & Archiviazione di tutti i dati elaborati nel database & \centering Obbligatorio & \makecell[tc]{Capitolato \\ FC1.2}  \\
			%fase 2
			\hline
			\centering RSFO5 & Elaborazione in tempo reale dei dati acquisiti da flussi esterni &\centering  Obbligatorio & \makecell[tc]{Capitolato}  \\
			\hline
			\centering RSFO5.1 & Identificazione di eventi che portano alla variazione del flusso di utenti &\centering  Obbligatorio & \makecell[tc]{Capitolato}  \\
			\hline
			\centering RSFD6 & Previsione dell'insorgenza futura di variazioni significative di flussi di persone & \centering Desiderabile & \makecell[tc]{Capitolato \\ FC2}  \\
			%fase 3
			\hline
			\centering RSFO7 & Visualizzazione dei dati elaborati attraverso heat map &\centering  Obbligatorio & \makecell[tc]{Capitolato \\ FC3.1}  \\
			\hline
			\centering RSFO8 & Apache Kafka$_{\scaleto{G}{3pt}}$ deve poter comunicare con il database, l'applicazione web e il modello di Machine Learning  &\centering  Obbligatorio &  \makecell[tc]{Interno \\ FC1.3} 	\\	
			\hline
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	...
	\begin{center}
		...
		\makecell[c]{\textbf{Codice RS}} & \makecell[c]{\textbf{Descrizione}} & \makecell[c]{\textbf{Tipo di requisito}} & \makecell[c]{\textbf{Fonte}} \\
		\hline
		\centering RSPO1 & Capacità di acquisizione continuativa nel tempo dei dati da flussi esterni &\centering  Obbligatorio & \makecell[tc]{Capitolato}  \\
		\hline
		\centering RSPO2 & Modalità a bassa latenza dell'aquisizione di informazioni & \centering Obbligatorio & \makecell[tc]{Capitolato} \\
		\hline
	...
	%	\hline
		...
		\hline
		\centering RSQO5  & Test che dimostrino il corretto funzionamento dei servizi e delle funzionalità previste  & \centering Obbligatorio & \makecell[tc]{Capitolato} \\
		\hline
		\rowcolor{white}
...
\begin{center}
	...
	\begin{longtable}{|p{4cm}|p{4cm}|p{4cm}|p{3cm}|}
		...
		\hline
		\centering RSVO2  & Il front-end$_{\scaleto{G}{3pt}}$ del prodotto viene sviluppato utilizzando tecnologie web &\centering Obbligatorio  & \makecell[tc]{Capitolato\\FC3.1} \\
		\hline
		\centering RSVF2.1  & Utilizzo di leaflet.js per la creazione di heat map$_{\scaleto{G}{3pt}}$ &\centering  Facoltativo & \makecell[tc]{Capitolato\\FC3.1} \\
		\hline
		\centering RSVO2.2  & Utilizzo di angular.js per la creazione della wep-app  &\centering  Obbligatorio  & \makecell[tc]{Capitolato\\FC3.1} \\
		\hline
		...
		\hline
		\centering RSVO4  & Il back end$_{\scaleto{G}{3pt}}$ del prodotto viene sviluppato utilizzando il linguaggio Java$_{\scaleto{G}{3pt}}$ &\centering  Obbligatorio  & \makecell[tc]{Capitolato\\FC3.2} \\
		\hline
		\rowcolor{white}
...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	\begin{center}
		...
		\hline
		\makecell[tc]{RSFO1} & \makecell[tc]{Capitolato\\V. esterno 17-12-2020 \\ FC1.1} \\
		\hline
		\makecell[tc]{RSFF2} & \makecell[tc]{Capitolato \\ FC1.1}\\
		\hline
		\makecell[tc]{RSFO3} & \makecell[tc]{Interno\\FC1.1}\\
		\hline
		\makecell[tc]{RSFO4.1} & \makecell[tc]{Capitolato\\FC1.2}\\
		\hline
		\makecell[tc]{RSFO4.2} & \makecell[tc]{Capitolato\\FC1.2}\\
		\hline
		\makecell[tc]{RSFO5} & \makecell[tc]{Capitolato}\\
		\hline
		\makecell[tc]{RSFO5.1} & \makecell[tc]{Capitolato}\\
		\hline
		\makecell[tc]{RSFD6 }& \makecell[tc]{Capitolato \\ FC2}\\
		\hline
		\makecell[tc]{RSFO7} & \makecell[tc]{Capitolato\\FC3.1}\\
		\hline
		\makecell[tc]{RSFO8} & \makecell[tc]{Interno \\FC1.3}\\
		\hline
		\makecell[tc]{RSPO1} & \makecell[tc]{Capitolato}\\
		\hline
		\makecell[tc]{RSPO2} & \makecell[tc]{Capitolato}\\
		\hline
		...
		\hline
		\makecell[tc]{RSQO5} & \makecell[tc]{Capitolato}\\
		\hline
		...
		\hline
		\makecell[tc]{RSVO2} & \makecell[tc]{Capitolato\\FC3.1}\\
		\hline
		\makecell[tc]{RSVF2.1} & \makecell[tc]{Capitolato\\FC3.1}\\
		\hline
		\makecell[tc]{RSVO2.2} & \makecell[tc]{Capitolato\\FC3.1}\\
		\hline
		\makecell[tc]{RSVO3} & \makecell[tc]{Capitolato\\FC1.3}\\
		\hline
		\makecell[tc]{RSVO4} & \makecell[tc]{Capitolato\\FC3.2}\\
		\hline
		\rowcolor{white}
