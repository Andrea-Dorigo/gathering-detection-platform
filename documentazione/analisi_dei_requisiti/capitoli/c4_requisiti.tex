...
{\rowcolors{2}{RawSienna!90!RawSienna!20}{RawSienna!70!RawSienna!40}
	\begin{center}
		...
		\hline
		\makecell[tc]{RSFO26} & \makecell[tc]{UC8.1}\\
		\hline
		\makecell[tc]{RSFO27} & \makecell[tc]{UC8.2}\\
		\hline
		\makecell[tc]{RSFO28} & \makecell[tc]{UC8.3}\\
		\hline
		...
		\hline
		\makecell[tc]{RSFO32.1} & \makecell[tc]{UC3}\\
		\hline
		\makecell[tc]{RSFO32.1.1} & \makecell[tc]{UC3}\\
		\hline
		\makecell[tc]{RSFO32.1.2} & \makecell[tc]{UC3}\\
		\hline
		\makecell[tc]{RSFO32.1.3} & \makecell[tc]{UC3}\\
		\hline
		\makecell[tc]{RSFO32.2} & \makecell[tc]{UC3}\\
		\hline
		...
		\hline
		\makecell[tc]{RSVO8} & \makecell[tc]{Interno}\\
		\hline
		\rowcolor{white}
