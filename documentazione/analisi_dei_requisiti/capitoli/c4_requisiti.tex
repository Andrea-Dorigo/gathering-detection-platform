...
{\rowcolors{2}{Apricot!90!Bittersweet!20}{Bittersweet!70!Apricot!40}
	...
	\begin{center}
		...
		\begin{tabularx}{\textwidth}{ |c|X|c|X| }
			...
			\hline
				\end{tabularx}\captionof{table}{Requisiti funzionali}
		\end{center}
		\begin{center}
		\renewcommand{\arraystretch}{1.4}
		\begin{tabularx}{\textwidth}{ |c|X|c|X| }
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{ |c|X|c|X| }
		...
		\hline
	\end{tabularx}\captionof{table}{Requisiti prestazionali}
\end{center}
...
%	\hline
	...
	\hline
	\end{tabularx}\captionof{table}{Requisiti di qualità}
\end{center}
...
\hline
	...
	\end{tabularx}\captionof{table}{Tabella tracciamento requisito-fonte}
\end{center}
\begin{center}
	\renewcommand{\arraystretch}{1.4}
	\begin{tabularx}{\textwidth}{ |X|X| }
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{ |X|X| }
		...
		\end{tabularx}\captionof{table}{Tabella tracciamento fonte-requisito}
\begin{tabularx}{\textwidth}{ |X|X| }
	\hline
	\rowcolor{Melon}
	\makecell[c]{\textbf{Fonte}} & \makecell[c]{\textbf{Codice RS}}  \\
