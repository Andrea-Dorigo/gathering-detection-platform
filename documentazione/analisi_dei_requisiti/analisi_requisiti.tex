...
\begin{titlepage}
	\begin{center}
		...
		\begin{table}[H]
			...
			\centering
			\begin{tabular}{r | l}
				\textbf{Versione} & v2.0.0 \\%RIGA PER INSERIRE LA VERSIONE ULTIMA DEL DOCUMENTO
				\textbf{Data approvazione} & 17-02-2021\\
				\textbf{Responsabile} & Mattia Cocco\\
				\textbf{Redattori} & \makecell[tl]{Andrea Cecchin } \\
				\textbf{Verificatori} & \makecell[tl]{Andrea Dorigo \\ Mattia Cocco } \\
...
\input{capitoli/c2_descrizione_generale}
%\input{capitoli/c3_fasi_progetto}
\input{capitoli/c3_5_casi_d_uso}
\input{capitoli/c4_requisiti}
